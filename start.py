...
def banner():
    print(f'''
                    ...
                    {white}    @@@@@@@   @@@@@@@@@@@@@@@@@@@@@@@                       
                       @@@@@@@@@@   @@@@@@@@@@@@@@@@@@@@@&          
                       @@@@@@@@@@@@   @@@@@@@@@@@@@@@@@@@@ 
                      .@@@@@@@@@@@@@*  &@@@@@@@@@@@@@@@@@@ {green}| Github :: sajadtlpr{white}   
                       @@@@@@@@@@@&  ,@@@@@@@@@@@@@@@@@@@@ {yellow}| ToolName TLPR-OFFSEC-LAB{white}
                       @@@@@@@@@@   @@@@@@@@@@@@@@@@@@@@@& {blue}| Current Version :: 0.1.1{white}     
                        @@@@@@@   @@@@@@@/        &@@@@@@                      
                          @@@@@@@@@@@@@@@@@@@@@@@@@@@@@                        
                            @@@@@@@@@@@@@@@@@@@@@@@@@                          
                               @@@@@@@@@@@@@@@@@@@                            
  ...
  _____ _                   _____  __  __                      _           _           _____      _               
|_   _| |                 |  _  |/ _|/ _|                    | |         | |         /  ___|    | |              
  | | | |_ __  _ __ ______| | | | |_| |_ ___  ___  ___ ______| |     __ _| |__ ______\ `--.  ___| |_ _   _ _ __  
  | | | | '_ \| '__|______| | | |  _|  _/ __|/ _ \/ __|______| |    / _` | '_ \______|`--. \/ _ \ __| | | | '_ \ 
  | | | | |_) | |         \ \_/ / | | | \__ \  __/ (__       | |___| (_| | |_) |     /\__/ /  __/ |_| |_| | |_) |
  \_/ |_| .__/|_|          \___/|_| |_| |___/\___|\___|      \_____/\__,_|_.__/      \____/ \___|\__|\__,_| .__/ 
        | |                                                                                               | |    
        |_|                                                                                               |_|    
    ''')
    print(f'{yellow}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
...
def update():
    ...
    git_ver = str(
        requests.get(
            "https://raw.githubusercontent.com/sajdtlpr/tlproffseclab/main/.version"
        ).text
    ).split()
    if version == git_ver[0]:
        ...
        changelog = requests.get(
            "https://raw.githubusercontent.com/sajdtlpr/tlproffseclab/main/.changelog.log"
        ).text
        update_commands = requests.get(
            "https://raw.githubusercontent.com/sajdtlpr/tlproffseclab/main/.update"
        ).text
        system("clear")
        banner()
        print(
